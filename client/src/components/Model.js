...
const Model = ({ setIsShowModel, content, name, handleSubmit, queries, arrMinMax, defaultText }) => {
    ...
    // 11% => 1.65 * 10 = 16.5 / 5 = 3 dư 2 => 4 * 5 = 20 / 10 = 2 triệu  
    ...
    return (
        <div onClick={() => { setIsShowModel(false) }}
                    ...
                    <div className='flex flex-col items-center justify-center relative'>
                        <div className='z-30 absolute top-[-48px] font-bold text-xl text-orange-600'>
                            {(persent1 === 100 && persent2 === 100)
                                ...
                                : `Từ ${persent1 <= persent2 ? convert100totarget(persent1) : convert100totarget(persent2)} - ${persent2 >= persent1 ? convert100totarget(persent2) : convert100totarget(persent1)} ${name === 'price' ? 'triệu' : 'm2'} `}
